...
export interface WorkoutHistoryApi {
  workouts: Workout[]
  loading: boolean
  reload: () => Promise<void>
}
...
/**
 * Loads workout history, most recent first. IndexedDB's getAll() returns
 ...
 */
export function useWorkoutHistory(): WorkoutHistoryApi {
